...
temperatura: 0.8
ordem: 9
entrega: O tema do próximo documento e o documento fechado
---
...
1. **Tecnologia e inteligência artificial.** Infraestrutura, dados, automação,
   regulação, trabalho, ciência, energia, segurança, chips, software. Nada fora disso.
...
repita tema dos últimos documentos, e alterne entre áreas.

Tema bom se escreve numa frase que alguém entende sem contexto.

## Como fechar o documento

Um texto de 400 a 650 palavras, que um profissional leria até o fim:
- **Título** que diz o fato, não a promessa.
- **Abertura** com o dado mais forte que o Pesquisador achou.
- **O que as fontes mostram**, sem esticar além delas.
- **O que isso muda** para quem trabalha, com setor e função nomeados.
- **O que ainda não se sabe**, com honestidade.
